...
module.exports = Contract_deploy('TYBENGToken', {
  contract: 'TYBENGToken',
  args: [
    {name: 'tokenName', value: 'TYBENG'},
    {name: 'tokenSymbol', value: 'TYBENG'},
...
module.exports.tags = ['TYBENGToken_deploy'];
